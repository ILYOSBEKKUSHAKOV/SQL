...
VALUES
('John', 'Doe', 'Software Engineer', 'IT', '2020-03-15', 75000.00),
('Jane', 'Smith', 'HR Manager', 'HR', '2018-07-22', 68000.00),
('Michael', 'Johnson', 'Accountant', 'Finance', '2019-01-10', 60000.00),
('Emily', 'Davis', 'Marketing Specialist', 'Marketing', '2021-06-01', 55000.00),
('David', 'Brown', 'IT Support', 'IT', '2022-02-18', 48000.00),
('Sarah', 'Miller', 'Project Manager', 'Operations', '2017-11-05', 82000.00),
('Robert', 'Wilson', 'Business Analyst', 'Finance', '2020-09-12', 70000.00),
('Olivia', 'Taylor', 'Recruiter', 'HR', '2021-04-25', 52000.00),
('James', 'Anderson', 'Data Scientist', 'IT', '2019-12-30', 90000.00),
('Sophia', 'Martinez', 'Sales Executive', 'Sales', '2022-08-14', 58000.00);

select top 5 * from Employees

create table Products (ProductId int primary key identity (100,5), ProductName Nvarchar(50), 
Category nvarchar(50), Price decimal (10,2))
Insert into Products (ProductName, Category, Price) values 
('Iphone17','Smartphone',1599.99),('Macbook','Laptop',1899.99),('Iphone16Plus','Smartphone',1399.99),
('Iwatch','Smartwatch',399.99),('Ipad','Planshet',599.99)
...
VALUES
('John', 'Doe', 'john.doe@email.com', '555-1234', 'New York', 'USA'),
('Anna', 'Smith', 'jane.smith@email.com', '555-5678', 'Los Angeles', 'USA'),
('Michael', 'Brown', 'michael.brown@email.com', '555-8765', 'Chicago', 'USA'),
('Emily', 'Davis', 'emily.davis@email.com', '555-4321', 'Houston', 'USA'),
('David', 'Wilson', 'david.wilson@email.com', '555-2468', 'Miami', 'USA'),
('Sophia', 'Taylor', 'sophia.taylor@email.com', '555-1357', 'Toronto', 'Canada'),
('Alice', 'Anderson', 'james.anderson@email.com', '555-9753', 'Vancouver', 'Canada'),
('Olivia', 'Martinez', 'olivia.martinez@email.com', '555-8642', 'London', 'UK'),
('Robert', 'Garcia', 'robert.garcia@email.com', '555-1122', 'Madrid', 'Spain'),
('Isabella', 'Lee', 'isabella.lee@email.com', '555-3344', 'Sydney', 'Australia');
...
add Emails nvarchar (100) NOT NULL Default ('noemail@example.com')
...
(40, 'Gary', 'Wright', 'Marketing', 87000.00, '2021-01-10', 29, NULL, 'UK');
 ...
 select EmployeeID, FirstName, LastName, DepartmentName, Salary, HireDate, Age, Email, Country, 
 coalesce(FirstName, LastName, 'Not Goven')
 from Employees
